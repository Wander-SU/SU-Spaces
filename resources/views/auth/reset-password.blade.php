    ...
    <div class="relative min-h-screen overflow-hidden bg-center bg-no-repeat" style="background-image: url('{{ asset('images/log_in_background.jpeg') }}'); background-size: 120vmin;">
        ...
        <div class="relative z-10 mx-auto flex min-h-screen w-full items-center justify-center p-4 sm:p-6 md:p-8">
            <div class="w-full max-w-xl mx-auto my-auto p-5 sm:p-6 bg-white/40 backdrop-blur-md border border-[#1d2d54]/10 rounded-2xl shadow-xs flex flex-col justify-between max-h-[85vh] overflow-y-auto dark:border-white/15 dark:bg-[#111110]/40">
                ...
                <form action="{{ route('password.store') }}" method="POST" class="mt-5 space-y-3" novalidate>
                    @csrf
                    ...
                    <div>
                        ...
                        <input id="email" type="email" name="email" value="{{ old('email', $email ?? '') }}" class="w-full rounded-lg border border-white/55 bg-white/58 px-3.5 py-2 text-sm text-[#1b1b18] outline-none transition focus:border-[#1b1b18] focus:ring-2 focus:ring-[#1b1b18]/15 dark:border-white/20 dark:bg-[#171716]/70 dark:text-[#EDEDEC] dark:focus:border-[#EDEDEC] dark:focus:ring-[#EDEDEC]/15" required autofocus>
                        <x-input-error :messages="$errors->get('email')" class="mt-2" />
                    </div>

                    <div>
                        <label for="password" class="mb-2 block text-base font-medium text-[#1b1b18] dark:text-[#EDEDEC]">New Password</label>
                        <input id="password" type="password" name="password" class="w-full rounded-lg border border-white/55 bg-white/58 px-3.5 py-2 text-sm text-[#1b1b18] outline-none transition focus:border-[#1b1b18] focus:ring-2 focus:ring-[#1b1b18]/15 dark:border-white/20 dark:bg-[#171716]/70 dark:text-[#EDEDEC] dark:focus:border-[#EDEDEC] dark:focus:ring-[#EDEDEC]/15" required>
                    ...
                    <div>
                        ...
                        <input id="password_confirmation" type="password" name="password_confirmation" class="w-full rounded-lg border border-white/55 bg-white/58 px-3.5 py-2 text-sm text-[#1b1b18] outline-none transition focus:border-[#1b1b18] focus:ring-2 focus:ring-[#1b1b18]/15 dark:border-white/20 dark:bg-[#171716]/70 dark:text-[#EDEDEC] dark:focus:border-[#EDEDEC] dark:focus:ring-[#EDEDEC]/15" required>
                    </div>
