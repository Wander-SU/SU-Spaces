...
<div>
    <div x-data>
        ...
        @click="Livewire.dispatch('roomSelected',{roomName:'ovbShaba',room_id:70})"
            ...
            <rect
                style="fill:{{ $this->roomColor('SLS Shaba') }};stroke:{{ in_array($this->roomStatuses['SLS Shaba'] ?? 'available', ['base_booking','at_capacity'], true) ? '#fecdd3' : '#a7f3d0' }};stroke-width:1.565"
                id="rect2"
                width="337.67953"
                height="126.75971"
                x="34.28746"
        ...
        @click="Livewire.dispatch('roomSelected',{roomName:'ovbZumaridi',room_id:71})"
            ...
            <rect
                style="fill:{{ $this->roomColor('SLS Zumaridi') }};stroke:{{ in_array($this->roomStatuses['SLS Zumaridi'] ?? 'available', ['base_booking','at_capacity'], true) ? '#fecdd3' : '#a7f3d0' }};stroke-width:1.49535"
                id="rect3"
                width="433.3385"
                height="122.34736"
                x="32.177677"
