...
<div x-data>
    ...
    <g
       ...
       @click="Livewire.dispatch('roomSelected',{roomName:'f5-04',room_id:20})"
        ...
        <rect
            style="fill:{{ $this->roomColor('STMB F5-04') }};stroke:{{ in_array($this->roomStatuses['STMB F5-04'] ?? 'available', ['base_booking','at_capacity'], true) ? '#fecdd3' : '#a7f3d0' }};stroke-width:1.93521"
            id="rect4-5"
            width="638.97113"
            height="357.91144"
            x="37.24678"
       ...
       @click="Livewire.dispatch('roomSelected',{roomName:'f5-01',room_id:17})"
        transform="translate(12.78607,1.399037)">
        <rect
            style="fill:{{ $this->roomColor('STMB F5-01') }};stroke:{{ in_array($this->roomStatuses['STMB F5-01'] ?? 'available', ['base_booking','at_capacity'], true) ? '#fecdd3' : '#a7f3d0' }};stroke-width:1.565"
            id="rect2"
            width="619.25238"
            height="328.32843"
            x="764.71429"
       ...
       @click="Livewire.dispatch('roomSelected',{roomName:'f5-05',room_id:21})"
        transform="translate(12.78607,1.399037)">
        <rect
            style="fill:{{ $this->roomColor('STMB F5-05') }};stroke:{{ in_array($this->roomStatuses['STMB F5-05'] ?? 'available', ['base_booking','at_capacity'], true) ? '#fecdd3' : '#a7f3d0' }};stroke-width:1.63522"
            id="rect3"
            width="719.1795"
            height="362.85004"
            x="677.22015"
       ...
       @click="Livewire.dispatch('roomSelected',{roomName:'f5-02',room_id:18})"
        transform="translate(12.78607,1.399037)">
        <rect
            style="fill:{{ $this->roomColor('STMB F5-02') }};stroke:{{ in_array($this->roomStatuses['STMB F5-02'] ?? 'available', ['base_booking','at_capacity'], true) ? '#fecdd3' : '#a7f3d0' }};stroke-width:1.92453"
            id="rect4"
            width="641.75116"
            height="336.28104"
            x="37.584267"
       ...
       @click="Livewire.dispatch('roomSelected',{roomName:'f5-03',room_id:19})"
        transform="translate(12.78607,1.399037)">
        <rect
            style="fill:{{ $this->roomColor('STMB F5-03') }};stroke:{{ in_array($this->roomStatuses['STMB F5-03'] ?? 'available', ['base_booking','at_capacity'], true) ? '#fecdd3' : '#a7f3d0' }};stroke-width:1.92453"
            id="rect4-7"
            width="638.0777"
            height="290.20795"
            x="38.214272"
